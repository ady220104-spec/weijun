...
- 二级页面正式终验：`2026-08-31T11:13:32Z`
- 首页回归终验：`2026-08-31T11:14:25Z`
- 本地 UX Audit 判定：**PASS**
...
首页两视口回归：2/2 PASS；LCP 最差 188ms、CLS 0、INP 最差 64ms、load 最差 148.7ms、产品资源传输最差 124,926 bytes、axe Critical/Serious 0。
